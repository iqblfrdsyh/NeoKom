  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.user.role !== "teacher") {
        Swal.fire({
          title: "Access Denied, Illegal Access!",
          text: "Mohon gunakan akun Guru untuk mengakses admin",
          icon: "error",
        ...
        <div className="grid grid-cols-2 items-center">
          <div className="relative overflow-hidden ">
            ...
            <div className="absolute inset-0 flex justify-end items-center">
              <Image
                src="/assets/images/login-ilustration-2.svg"
                alt="illustration"
                width={600}
                height={600}
          ...
          <div className="absolute w-[240px] h-[100px] right-44 top-14">
            <Image
          ...
          <div className="px-16 flex-1 absolute right-16">
